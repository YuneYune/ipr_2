...
Функционал: REST заглушки
  ...
  @post
  Сценарий: [00] Делая POST запрос с данными пропуска, в ответе получаем id пропуска
  ...
  @get1
  Сценарий: [01] Делая GET запрос с существующим id пропуска, получаем всю инф. о пропуске
    * Послали POST на URL "http://localhost:1488/pass/" с параметрами:
      | key             | value      |
      | first_name      | Gussi      |
      | last_name       | Gang       |
